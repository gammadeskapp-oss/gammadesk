        ...
        <details className="panel px-3.5 py-3 text-2xs leading-relaxed text-term-faint">
          ...
          <ul className="mt-1.5 space-y-0.5 tabular-nums">
            {[
              ...
              ['Base price range too wide', view.funnel.droppedBaseTooWide],
              ['Base was already trending up (not flat)', view.funnel.droppedBaseTrending],
              ['Base volume already rising sharply (the 2× rule)', view.funnel.droppedBaseVolRising],
