...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      // Declared ahead of the PNGs so a browser that wants a tab icon takes
      // the multi-size .ico and picks the crop it needs, rather than
      // downscaling the 512 and losing the glyph.
