 ...
 *
 * The closing X post no longer rides here — it has its own 3:20 PM CT cron
 * (`/api/x/closing`) so it goes out near the bell rather than with the evening
 * digest. This route is back to being the Discord digest alone.
 *
