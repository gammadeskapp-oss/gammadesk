...
import type { VelocityTag } from '@/lib/velocity/types';
      ...
      <main className="mx-auto w-full max-w-[1700px] flex-1 space-y-4 px-4 py-5 sm:px-6">
        ...
        <div className="panel border-l-2 border-l-flip/60 px-3.5 py-3 text-xs leading-relaxed">
          ...
          <p className="mt-2 text-term-dim">
            ...
            expiries falling out of the window, hedges against stock. A strike
            can grow because someone is defending it or because someone is
            trapped at it, and this data cannot distinguish those. Read it as
            where the book moved, and nothing more.
          </p>
        </div>
        ...
        {data.snapshotsStored === 0 ? (
          ...
          <div className="panel px-4 py-10 text-center text-xs text-term-dim">
            <p className="text-term-text">No material change.</p>
            <p className="mx-auto mt-2 max-w-xl leading-relaxed">
              No strike moved more than $2M in dollar gamma between{' '}
            ...
            <div className="scroll-term max-h-[70vh] overflow-auto">
              <table className="w-full border-separate border-spacing-0 text-right text-xs tabular-nums">
                <caption className="sr-only">
                  Largest day-over-day changes in per-strike dollar gamma.
                </caption>
                <thead>
                  <tr>
                    ...
                    <th scope="col" className={`${head} text-left`}>Tag</th>
                  </tr>
                </thead>
                <tbody>
                  {data.rows.map((r) => (
